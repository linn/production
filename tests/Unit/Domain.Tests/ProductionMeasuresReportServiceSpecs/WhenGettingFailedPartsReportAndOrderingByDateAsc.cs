namespace Linn.Production.Domain.Tests.ProductionMeasuresReportServiceSpecs
{
    ...
    public class WhenGettingFailedPartsReportAndOrderingByDateAsc : ContextBase
    {
        ...
        public void SetUp()
        {
            this.results = this.Sut.FailedPartsReport(null, null, "ASC", false, null, null);
        }
        ...
        [Test]
        public void ShouldReturnResultsDateAscending()
        {
            var report1 = this.results.First();
            report1.Rows.Should().HaveCount(4);
            report1.GetGridTextValue(report1.RowIndex("0"), report1.ColumnIndex("Date Booked")).Should().Be("01-Jul-2019");
            ...
            report1.GetGridTextValue(report1.RowIndex("3"), report1.ColumnIndex("Date Booked")).Should().Be("01-Aug-2021");
        }
    }
}