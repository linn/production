            ...
            var columns = new List<AxisDetailsModel>
                              {
                                  ...
                                  new AxisDetailsModel("WO") { SortOrder = 2, GridDisplayType = GridDisplayType.TextValue },
                                  new AxisDetailsModel("WO Qty") { SortOrder = 3, GridDisplayType = GridDisplayType.Value },
                                  new AxisDetailsModel("Qty On Board") { SortOrder = 4, GridDisplayType = GridDisplayType.Value },
                                  new AxisDetailsModel("Qty Required") { SortOrder = 5, GridDisplayType = GridDisplayType.Value },
