namespace Linn.Production.Persistence.LinnApps
{
    ...
    public class ServiceDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            this.BuildWorksOrderMessages(builder);
        ...
        private void BuildWorksOrderMessages(ModelBuilder builder)
        {
            builder.Entity<WorksOrderMessage>().ToTable("WORKS_ORDER_MESSAGES");
