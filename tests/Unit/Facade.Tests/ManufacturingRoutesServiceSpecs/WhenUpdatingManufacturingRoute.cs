    ...
    public class WhenUpdatingManufacturingRoute : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            this.resource = new ManufacturingRouteResource
            {
                ...
                Notes = "noted",
                Operations = new List<ManufacturingOperationResource> { this.opResource }
            };

            this.ManufacturingRouteRepository.FindById(this.manufacturingRoute.RouteCode)
                .Returns(this.manufacturingRoute);

            this.ManufacturingOperationRepository.FindById(this.manufacturingOperation.ManufacturingId)
        ...
        public void ShouldReturnSuccess()
        {
            ...
            dataResult.Operations.Any(
                x => x.RouteCode == this.manufacturingOperation.RouteCode
                     && x.OperationNumber == this.manufacturingOperation.OperationNumber).Should().BeTrue();
        }
    }
}
