namespace Linn.Production.Service.Tests.ProductionMeasuresModuleSpecs
{
    ...
    public class WhenGettingFailedPartsReport : ContextBase
    {
        ...
        public void SetUp()
        {
            this.ProductionMeasuresReportFacade.GetFailedPartsReport("S", null, null, false, null, null)
        ...
        {
            this.ProductionMeasuresReportFacade.Received().GetFailedPartsReport("S", null, null, false, null, null);
        }
