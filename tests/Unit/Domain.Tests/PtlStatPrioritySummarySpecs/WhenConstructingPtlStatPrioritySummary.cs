namespace Linn.Production.Domain.Tests.PtlStatPrioritySummarySpecs
{
    ...
    public class WhenConstructingPtlStatPrioritySummary
    {
        ...
        public void SetUp()
        {
            ...
            {
                new PtlStat { PtlPriority = 1, WorkingDays = 0m },
                new PtlStat { PtlPriority = 1, WorkingDays = 1m },
                new PtlStat { PtlPriority = 1, WorkingDays = 2m },
                new PtlStat { PtlPriority = 1, WorkingDays = 4m },
                new PtlStat { PtlPriority = 1, WorkingDays = 8m }
            };
        ...
        [Test]
        public void ShouldHaveCorrectPercBy5Days()
        {
            this.Sut.PercBy5Day().Should().Be(80);
        }
    }
}
