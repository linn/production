    ...
    public class WhenGettingReport : ContextBase
    {
        ...
        public void SetUp()
        {
            ...
            var triggers = new List<ProductionTrigger>
            {
                ...
                new ProductionTrigger {Priority = "1", PartNumber = "SOLO/1/BP", CanBuild = 0, ReqtForInternalAndTriggerLevelBT = 2, KanbanSize = 1},
                new ProductionTrigger {Priority = "1", PartNumber = "LINGO 4 PSU", CanBuild = 1, ReqtForInternalAndTriggerLevelBT = 1, KanbanSize = 1},
                new ProductionTrigger {Priority = "2", PartNumber = "MAJ DISPLAY", CanBuild = 3, ReqtForInternalAndTriggerLevelBT = 6, KanbanSize = 0},
