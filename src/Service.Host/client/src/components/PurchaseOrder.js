...
PurchaseOrder.propTypes = {
    ...
    issueError: PropTypes.shape({ statusText: PropTypes.string, item: PropTypes.string }),
    buildError: PropTypes.shape({ statusText: PropTypes.string, item: PropTypes.string }),
