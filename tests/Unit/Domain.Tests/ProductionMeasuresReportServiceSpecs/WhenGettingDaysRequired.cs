namespace Linn.Production.Domain.Tests.ProductionMeasuresReportServiceSpecs
{
    ...
    public class WhenGettingDaysRequired : ContextBase
    {
        ...
        public void SetUp()
        {
            this.results = this.Sut.DayRequiredReport(null);
        }
        ...
        public void ShouldReturnResults()
        {
            ...
            report2.Rows.Should().HaveCount(3);
            report2.GetGridTextValue(report2.RowIndex("0"), report2.ColumnIndex("Part Number")).Should().Be("p3");
            report2.GetGridTextValue(report2.RowIndex("1"), report2.ColumnIndex("Part Number")).Should().Be("p4");
            ...
            report2.GetGridValue(report2.RowIndex("2"), report2.ColumnIndex("Qty Being Built")).Should().Be(2);
            ...
            report2.GetGridValue(report2.RowIndex("2"), report2.ColumnIndex("Build")).Should().Be(4);
            ...
            report2.GetGridValue(report2.RowIndex("2"), report2.ColumnIndex("Can Build")).Should().Be(4);
            report2.GetGridValue(report2.RowIndex("0"), report2.ColumnIndex("Effective Kanban")).Should().Be(2);
            report2.GetGridValue(report2.RowIndex("1"), report2.ColumnIndex("Effective Kanban")).Should().Be(2);
            ...
            report2.GetGridTextValue(report2.RowIndex("2"), report2.ColumnIndex("Being Built Days")).Should().Be("2d 0h 0m");
            ...
            report2.GetGridTextValue(report2.RowIndex("2"), report2.ColumnIndex("Can Build Days")).Should().Be("4d 0h 0m");
        }
    }
}