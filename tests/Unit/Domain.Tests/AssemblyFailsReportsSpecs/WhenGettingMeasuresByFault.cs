namespace Linn.Production.Domain.Tests.AssemblyFailsReportsSpecs
{
    ...
    public class WhenGettingMeasuresByFault : ContextBase
    {
        ...
        public void ShouldSetReportTitle()
        {
            ...
            this.result.GetZeroPaddedGridValue(this.result.RowIndex("F1"), this.result.ColumnIndex("Total")).Should().Be(3);
            this.result.GetZeroPaddedGridValue(this.result.RowIndex("F2"), this.result.ColumnIndex("21")).Should().Be(2);
            this.result.GetZeroPaddedGridValue(this.result.RowIndex("F2"), this.result.ColumnIndex("Total")).Should().Be(2);
